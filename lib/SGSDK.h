...
void sg_Sprites_SpriteSetLayerOffsets(void *s, point2d *value, int value_len);
...
font_style sg_Text_GetFontStyle(void *font);
...
void sg_Text_SetFontStyle(void *font, font_style value);
