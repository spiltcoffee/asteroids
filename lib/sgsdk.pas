...
library SGSDK;
  ...
  function sg_Text_GetFontStyle(font: Font): FontStyle; cdecl; export;
  begin
    {$IFDEF TRACE}
      TraceEnter('SGSDK.dll', 'sg_Text_GetFontStyle');
    {$ENDIF}
    
    try
      result := sgText.GetFontStyle(font);
    Except on exc: Exception do 
      TrapException(exc, 'sg_Text_GetFontStyle');
    end;  
    
    {$IFDEF TRACE}
      TraceExit('SGSDK.dll', 'sg_Text_GetFontStyle');
    {$ENDIF}
  end;
  ...
  procedure sg_Text_SetFontStyle(font: Font; value: FontStyle); cdecl; export;
  begin
    {$IFDEF TRACE}
      TraceEnter('SGSDK.dll', 'sg_Text_SetFontStyle');
    {$ENDIF}
  
    try 
      sgText.SetFontStyle(font, value);
    Except on exc: Exception do 
      TrapException(exc, 'sg_Text_SetFontStyle');
    end;  
    
    {$IFDEF TRACE}
      TraceExit('SGSDK.dll', 'sg_Text_SetFontStyle');
    {$ENDIF}
  end;
  ...
  {$endif}
    ...
    sg_Text_GetFontStyle name 'sg_Text_GetFontStyle',
    ...
    sg_Text_SetFontStyle name 'sg_Text_SetFontStyle',
