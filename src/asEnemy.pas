...
interface
  ...
  procedure MoveEnemy(var enemy: TShip; const state: TState; const player: TShip; var asteroids: TAsteroidArray);

  procedure DrawEnemy(const enemy: TShip);

implementation
  uses sgCore, sgGeometry, sgGraphics, sgTypes, asAudio, asConstants, asDraw, asEffects, asNotes, asOffscreen;
